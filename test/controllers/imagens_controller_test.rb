...
class ImagensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create imagen" do
    assert_difference('Imagen.count') do
      post imagens_url, params: { imagen: { urlImagen: @imagen.urlImagen, urlImagenPrevia: @imagen.urlImagenPrevia } }
    end
  ...
  test "should update imagen" do
    patch imagen_url(@imagen), params: { imagen: { urlImagen: @imagen.urlImagen, urlImagenPrevia: @imagen.urlImagenPrevia } }
