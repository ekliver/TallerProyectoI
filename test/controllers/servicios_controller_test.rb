...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { inActivo: @servicio.inActivo, nomServicio: @servicio.nomServicio } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { inActivo: @servicio.inActivo, nomServicio: @servicio.nomServicio } }
